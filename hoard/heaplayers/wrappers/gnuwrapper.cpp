...
extern "C" {
  ...
  void (* volatile __malloc_initialize_hook)() = my_init_hook;	

  static void my_init_hook (void) {
    // Store the old hooks.
#ifndef _APPDIRMALLOC
    ...
    initialized = true;
	//fprintf(stderr, "INITIATING MALLOC HOOK \n");
#endif
  }
 ...
 void * xxrealloc (void * ptr, size_t sz) {
	...
	//fprintf(stdout,"calling reallco \n");
